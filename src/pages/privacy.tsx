        ...
        <div className="prose dark:prose-invert max-w-none">
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mt-4">
                We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" className="text-primary hover:underline">Free Privacy Policy Generator</a>.
              </p>
            </CardContent>
          </Card>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { term: "Application", definition: "refers to Target Mate, the software program provided by the Company." },
                    { term: "Company", definition: "(referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to Target Mate." },
          ...
          <section className="mb-12">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Sharing Your Personal Information</h3>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">Other legal requirements</h4>
                    <p className="text-muted-foreground mb-2">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
                    <ul className="list-disc pl-6 text-muted-foreground">
